...
export interface DarwinSwapPairInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "swapWithoutToks",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface DarwinSwapPair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DarwinSwapPairInterface;
  ...
  functions: {
    ...
    swap(
      ...
      firstAndLastInPath: [PromiseOrValue<string>, PromiseOrValue<string>],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
